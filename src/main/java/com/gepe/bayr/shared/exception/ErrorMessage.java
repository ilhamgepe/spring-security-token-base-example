...
public enum ErrorMessage {
    ...
    USER_EMAIL_ALREADY_EXISTS(HttpStatus.CONFLICT, "user.email_already_exists"),
    USER_NICKNAME_ALREADY_EXISTS(HttpStatus.CONFLICT, "user.nickname_already_exists"),
    USER_PHONE_ALREADY_EXISTS(HttpStatus.CONFLICT, "user.phone_already_exists"),
    USER_SUSPENDED(HttpStatus.FORBIDDEN, "user.suspended"),
    USER_DISABLED(HttpStatus.FORBIDDEN, "user.disabled"),

    // ##################################################
    // USER PROFILE
    // ##################################################
    USER_PROFILE_NOT_FOUND(HttpStatus.NOT_FOUND, "user_profile.not_found"),
    USER_PROFILE_NICKNAME_ALREADY_EXISTS(HttpStatus.CONFLICT, "user_profile.nickname_already_exists"),
    ...
    ErrorMessage(HttpStatus status, String messageKey) {
        this.status = status;
